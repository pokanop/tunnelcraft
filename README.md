...
**35 modules · 149 lessons · 51 hands-on labs · 34 quiz checkpoints (~55 h)** across four tracks:

| Track                      | Modules               | Covers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| -------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1 · Network Fundamentals   | N01–N19 (19)          | Layers & addressing, Ethernet/switching/VLANs/ARP, Wi-Fi & 802.11 (CSMA/CA, WPA2/WPA3, roaming, hostile hotspots), RF & modern Wi-Fi (dBm/SNR, MCS, MIMO/OFDMA, Wi-Fi 4→7), enterprise wireless (802.1X/EAP/RADIUS, dynamic VLANs, portals), IP/ICMP/IPv6, DHCP, subnetting mastery, UDP/TCP, TCP internals (windows, congestion control, states), routing/OSPF/BGP, NAT, DNS + DNS deep dive, TLS/DTLS/HTTP/QUIC, cellular & mobile links (scheduled radio, GTP, CGNAT, RRC & battery), IPv6 transition deep dive (NAT64/DNS64/464XLAT, prefix discovery via ipv4only.arpa & PREF64, CLAT/PLAT, v6-only testing for App Review), the troubleshooting toolbelt, security fundamentals & zero trust, cloud networking |
