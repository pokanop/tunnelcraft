...
engineering tracks so the fundamentals land as *reasons*, not trivia.
...
the right module *and* tab. The index is built at load from the same data the views
...
# terminal 2 — UI on :5173 (proxies /api → :4000)
npm run dev:client
```
