...
**32 modules · 133 lessons · 39 hands-on labs · 31 quiz checkpoints (~53 h)** across four tracks:

| Track                      | Modules               | Covers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| -------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1 · Network Fundamentals   | N01–N17 (16)          | Layers & addressing, Ethernet/switching/VLANs/ARP, Wi-Fi & 802.11 (CSMA/CA, WPA2/WPA3, roaming, hostile hotspots), RF & modern Wi-Fi (dBm/SNR, MCS, MIMO/OFDMA, Wi-Fi 4→7), enterprise wireless (802.1X/EAP/RADIUS, dynamic VLANs, portals), IP/ICMP/IPv6, subnetting mastery, UDP/TCP, TCP internals (windows, congestion control, states), routing/OSPF/BGP, NAT, DNS + DNS deep dive, TLS/DTLS/HTTP/QUIC, cellular & mobile links (scheduled radio, GTP, CGNAT, NAT64/464XLAT, RRC & battery), the troubleshooting toolbelt, security fundamentals & zero trust |
