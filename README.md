...
**37 modules · 162 lessons · 62 hands-on labs · 36 quiz checkpoints · 4 timed final exams (~58 h)** across four tracks:

| Track                      | Modules               | Covers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 · Network Fundamentals   | N01–N19 (19)          | Layers & addressing, Ethernet/switching/VLANs/ARP, Wi-Fi & 802.11 (CSMA/CA, WPA2/WPA3, roaming, hostile hotspots), RF & modern Wi-Fi (dBm/SNR, MCS, MIMO/OFDMA, Wi-Fi 4→7), enterprise wireless (802.1X/EAP/RADIUS, dynamic VLANs, portals), IP/ICMP/IPv6, DHCP (DORA, leases, relays, rogue-server attacks), subnetting mastery, UDP/TCP, TCP internals (windows, congestion control, states), routing/OSPF/BGP, NAT, DNS + DNS deep dive, TLS/DTLS/HTTP/QUIC, cellular & mobile links (scheduled radio, GTP, CGNAT, RRC & battery), IPv6 transition deep dive (NAT64/DNS64/464XLAT, prefix discovery via ipv4only.arpa & PREF64, CLAT/PLAT, v6-only testing for App Review), the troubleshooting toolbelt, security fundamentals & zero trust, cloud networking (VPCs, load balancers, IPsec & SD-WAN) |
| 2 · Rust for Systems       | R01–R07 (7)           | Ownership & types, idiomatic Rust (type-driven design, traits, error craft, zero-cost habits), async/Tokio, futures by hand (the poll contract, wakers, Pin, a mini executor), network programming, unsafe & FFI (aliasing rules, Send/Sync internals, atomics & memory ordering, the C ABI, opaque handles), professional tooling (workspaces, testing, CI gates, tracing)                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
an infinite VLSM subnet-design drill, packet hex-decode labs, Wireshark-style capture
analysis labs, term-matching drills, an infinite well-known-ports drill, and quizzes with
explanations (70% to pass). Self-contained Rust examples carry a one-click "run on
playground" link. Progress is tracked per lesson/lab/quiz.

**Final exams & certificates:** each track ends in a timed, certification-style final —
24 questions drawn fresh each sitting from the track's full question pool (module
quizzes + a 76-question supplemental bank), 30 minutes, auto-submit at zero, pass at
75%. Passing renders a printable certificate; anything you miss lands in the review deck.

**Glossary, notes & momentum:** a filterable 225-term field glossary deep-links every
term to the module that teaches it. Lessons support bookmarks, per-lesson notes, and
print/PDF export. A daily streak (with best-streak record) shows in the header, the
home page keeps a field-record panel plus your bookmarked lessons, and "resume" returns
to the exact lesson you left. Signed-in users can opt into study-reminder email on days
with no activity (Account → Study Reminders).
...
**Review mode:** every question you miss — module quiz, final exam, or any drill
(CIDR, VLSM, ports, hex/pcap labs) — becomes a spaced-repetition card on a
...
client/
  src/
    curriculum/     core.ts + net-a..d.ts, net-wifi.ts (all four wireless modules), rust-idiom.ts, rust-extra.ts, platform-a/b.ts, tracks.ts (+ types.ts)
