    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            p: "Where does the PAC come from, and who evaluates it? Discovery is **WPAD**: DHCP option 252 (N15), or probing `http://wpad.<domain>/wpad.dat` — convenient and a famous attack surface, since whoever answers for 'wpad' on a hostile network becomes everyone's proxy (a cousin of N02/N12's spoofing family; modern OSes dialed WPAD back for exactly this reason). Evaluation happens in per-OS engines — WinHTTP on Windows, CFNetwork on Apple, and browsers with their own — which is why 'system proxy' and 'browser proxy' can disagree.",
          },
          {
